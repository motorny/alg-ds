...
TEST(TestPutWord, Test_PutWord_CorrectWordPlacementisAfterTheFirstWordAndBeforTheSecondWord_BypassTheFirstWordAndPlaceItBeforeTheSecondWord) {
    char word1[] = "axc";
    char word2[] = "accp";
    char word3[] = "tye";
    ...
    ASSERT_STREQ(testlist.previous->string, word3);
    ASSERT_STREQ(testlist.previous->previous->string, word2);
    ASSERT_TRUE(testlist.previous->previous->previous == NULL);
}

TEST(TestPutWord, Test_PutWord_CorrectPlaceOfTheWordIsAfterAllPreviousOnes_BypassAllWordsAndWriteToTheEnd) {
    char word1[] = "axc";
    char word2[] = "tye";
    char word3[] = "accp";
...
TEST(TestWordToList, Test_WordToList_AddingTheSecondWord_SettingTheSecondWordToTheRightPlace) {
    char word1[] = "axc";
    char word2[] = "tye";
...
TEST(TestWordToList, Test_WordToList_AddingNotTheFirstOrTheSecondWord_CrawlingTheGeneratedListAndPlacingThwWordInTheCorrectPlace) {
    char word1[] = "axc";
    char word2[] = "accp";
    char word3[] = "tye";
