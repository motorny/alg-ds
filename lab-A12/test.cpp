...
TEST (AddElementToList_1ElementList_returnTrue) {
  ...
  AddElemToList(&list, "newElement1");

  AddElemToList(&list, "newElement2");
...
TEST (AddElementToList_2ElementsInList_returnTrue) {
  ...
  AddElemToList(&list, "newElement3");
...
TEST (AddElementToList_3andMoreElementsInList_returnTrue) {
  ...
  AddElemToList(&list, "newElement4");
...
TEST (AddElementToList_UppercaseString_returnFalse) {
  ...
  ASSERT_EQ(AddElemToList(&list, "012345678901234567890123456789"), 0);
...
TEST (FindElementInListByKey_UppercaseString_returnFalse) {
  ...
  ASSERT_EQ(FindElemInListByKey(&list, "012345678901234567890123456789"), 0);
...
TEST (FindElementInListByKey_EmptyList_returnFalse) {
  ...
  ASSERT_EQ(FindElemInListByKey(&list, "element"), 0);
  ASSERT_EQ(list.first, nullptr);
  ASSERT_EQ(list.second, nullptr);
}
...
TEST (FindElementInListByKey_1ElementList_returnTrue) {
  ...
  AddElemToList(&list, "newElement");
  ASSERT_EQ(FindElemInListByKey(&list, "newElement"), 1);
...
TEST (FindElementInListByKey_1ElementList_returnFalse) {
  ...
  AddElemToList(&list, "newElement");
  ASSERT_EQ(FindElemInListByKey(&list, "oldElement"), 0);
...
TEST (FindElementInListByKey_2andMoreElementsList_returnTrue) {
  ...
  AddElemToList(&list, "newElement1");
  AddElemToList(&list, "newElement2");
  ASSERT_EQ(FindElemInListByKey(&list, "newElement1"), 1);
  ASSERT_EQ(FindElemInListByKey(&list, "newElement2"), 1);
...
TEST (FindElementInListByKey_2andMoreElementsList_returnFalse) {
  ...
  AddElemToList(&list, "newElemen1");
  AddElemToList(&list, "newElemen2");
  ASSERT_EQ(FindElemInListByKey(&list, "newElement3"), 0);
  ASSERT_EQ(FindElemInListByKey(&list, "oldElement"), 0);
...
TEST (DeleteElementFromListByKey_UppercaseString_returnFalse) {
  ...
  ASSERT_EQ(DeleteElemFromListByKey(&list, "012345678901234567890123456789"), 0);
  ASSERT_EQ(strcmp(list.first->str, "newElement"), 0);
...
TEST (DeleteElementFromListByKey_EmptyList_returnFalse) {
  ...
  ASSERT_EQ(DeleteElemFromListByKey(&list, "element"), 0);
  ASSERT_EQ(list.first, nullptr);
  ASSERT_EQ(list.second, nullptr);
}
...
TEST (DeleteElementFromListByKey_1ElementList_returnTrue) {
  ...
  AddElemToList(&list, "newElement");
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement"), 1);
  ASSERT_EQ(list.first, nullptr);
}
...
TEST (DeleteElementFromListByKey_2ElementList_returnFalse) {
  ...
  AddElemToList(&list, "newElement1");
  AddElemToList(&list, "newElement2");
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement3"), 0);
  ASSERT_EQ(DeleteElemFromListByKey(&list, "oldElement"), 0);
...
TEST (DeleteElementFromListByKey_2ElementList_returnTrue) {
  ...
  AddElemToList(&list, "newElement1");
  AddElemToList(&list, "newElement2");
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement2"), 1);
  ASSERT_EQ(strcmp(list.first->str, "newElement1"), 0);
  ASSERT_EQ(list.second, nullptr);

  AddElemToList(&list, "newElement2");
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement1"), 1);
...
TEST (DeleteElementFromListByKey_3ElementList_returnTrue) {
  ...
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement3"), 1);
...
TEST (DeleteElementFromListByKey_MoreThan3ElementList_returnTrue) {
  ...
  ASSERT_EQ(DeleteElemFromListByKey(&list, "newElement4"), 1);
